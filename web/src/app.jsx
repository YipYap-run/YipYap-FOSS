...
import { clearUpgradePrompt } from './state/upgrade';
...
import { ReplyActivityPage } from './pages/admin/reply-activity';
...
function handleRoute(e) {
  // Track the active path so the sidebar re-renders on client-side navigation.
  currentPath.value = e.url;
  // Clear any upgrade banner so it doesn't follow the user to another page.
  clearUpgradePrompt();
...
export function App() {
  ...
  return (
    <Router onChange={handleRoute}>
      ...
      <AuthRoute path="/admin/reply-activity" component={ReplyActivityPage} />
    </Router>
  );
}
