...
export async function loadUser() {
  ...
  try {
    ...
    try {
      ...
      // Token may still be valid for reads even if refresh fails (e.g. staff-readonly).
      ...
      if (!currentUser.value) {
        ...
        try {
          ...
          currentUser.value = { id: 'staff', email: 'ops@yipyap.run', role: 'viewer', name: 'Staff (read-only)' };
          connectWS();
        } catch (_) {
