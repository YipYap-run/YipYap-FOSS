...
export function SupportFAB() {
  ...
  useEffect(() => {
    ...
    // Focus the first field, or the dialog itself on the success screen.
    (subjectRef.current || drawerRef.current)?.focus();
        ...
        <>
          ...
          >
            <div style={drawerHeaderStyle}>
              <h3 id="support-fab-title" style={{ margin: 0, fontSize: '1.125rem' }}>Contact Support</h3>
              <button style={closeBtnStyle} onClick={handleClose} title="Close" aria-label="Close">&times;</button>
            </div>
