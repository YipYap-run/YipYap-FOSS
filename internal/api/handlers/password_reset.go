...
// When SMTP is not configured the route appears unmounted (404), see the
// indistinguishable-from-unmounted note in ResendVerification. When SMTP
// IS configured, always returns 200 to prevent email enumeration.
